...
<body>
	...
	<div class="body">
		...
		<div class="container">
			...
			<br> <br> <br> <br>
			<div class="row">
				<h1 align="center"><b><u>ZIKA VIRUS</u></b></h1>
			</div>

			<div class="row">

				<div class="col-md-8 col-md-offset-3 ">
				<img src="img/team/zika.jpg" width="550" height="258.84" alt="traveler" class="responsive">
				</div>
			</div>
...
<div class="row mt-xl">
						<div class="col-md-8 col-md-offset-2 mt-xlg" align="left">
							...
							<div class="shiv">
								...
								The vertebrate hosts of the virus were primarily monkeys in a so-called enzootic mosquito-monkey-mosquito cycle, with only occasional transmission to humans.<br><br>

Zika is primarily spread by the female Aedes aegypti mosquito, which is active mostly in the daytime. The mosquitos must feed on blood in order to lay eggs. <br><br>

The infection, known as Zika fever or Zika virus disease, often causes no or only mild symptoms, similar to a very mild form of dengue fever. While there is no specific treatment, paracetamol (acetaminophen) and rest may help with the symptoms. <br><br>

As of 2016, the illness cannot be prevented by medications or vaccines. Zika can spread from a pregnant woman to her baby. This can result in microcephaly, severe brain malformations, and other birth defects. Zika infections in adults may result rarely in GuillainBarré syndrome.<br><br>
