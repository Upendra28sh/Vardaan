...
<title>vaccinefortravellers</title>
	...
	<div class="body">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-8 col-md-offset-2 ">
					<img src="img/team/Travellers1.jpg" width="650" height="358.84"
						alt="traveler" class="responsive">
				</div>
			</div>
		...
		<div class="row mt-xl">
			<div class="col-md-8 col-md-offset-2 mt-xlg" align="left">
				...
				<div class="shiv">WHO emphasizes that all travelers (domestic
					and international) should be up to date with routine vaccinations.<br>
					Travelling becomes a good opportunity for health care providers to
					review the immunization status of infants, children, adolescents
					and adults. Travellers should be advised to check that they have
					been fully vaccinated against measles, rubella, mumps, diphtheria,
					tetanus and pertussis (whooping cough) before starting their
					travel. <br>Unimmunized or incompletely immunized travellers should be
					offered the routine vaccinations recommended in their national
					immunization schedules, in addition to those needed for
					international travel. <br>Some countries require to check that you have received
					certain vaccines prior to entering the country. For example: Yellow
					fever vaccination is required by International Health Regulations
					for travel to some countries in sub-Saharan Africa and South
					America.<br> Saudi Arabia requires proof of meningococcal vaccination
					for all pilgrims and proof of polio vaccination for all children
					going to Mecca during the Hajj.<br> WHO recommends to visit a travel
					clinic or consult your healthcare provider preferably six weeks
					before you travel. This is important because some vaccines may take
					several weeks to become fully effective and others may require more
					than one dose</div>
			</div>
		</div>
