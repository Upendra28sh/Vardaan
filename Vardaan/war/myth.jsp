...
<body>
	...
	<div class="body">
		...
		<div class="container">
			...
			<br> <br> <br> <br>
			<div class="row">
				<h1 align="center"><b><u>MYTH</u></b></h1>
			</div>

			<div class="row">

				<div class="col-md-8 col-md-offset-3 ">
				<img src="img/team/Trump1.jpg" width="550" height="258.84" alt="traveler" class="responsive">
				<img src="img/team/Trump2.png" width="550" height="258.84" alt="traveler" class="responsive">
				<img src="img/team/Trump3.png" width="550" height="258.84" alt="traveler" class="responsive">
				</div>
			</div>
...
<div class="row mt-xl">
						...
						Anti-science and ignorance will rule the Trump White House.
There are many reasons to oppose Donald Trump. One such reason is the scientific ignorance and misinformation promoted by Trump and his running mate Mike Pence.
Trump claims vaccines cause autism and also believes global warming is a hoax. Pence have suggested that smoking doesnt kill, and denies evolution.
